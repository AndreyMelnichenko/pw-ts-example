...
export class EventSummary2 extends EventSummary1 {
    ...
    override async pageLoaded(): Promise<EventSummary1> {
        ...
        await this.uiElement.waitForElementVisible("//h3[contains(text(),'Your Event Update')]", 5000)
        await this.uiElement.waitForElementVisible("//h4[text()=' Your Shortlisted Services ']", 5000)
